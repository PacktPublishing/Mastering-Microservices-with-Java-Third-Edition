...
public class InMemBookingRepository implements BillingRepository<Billing, String> {
    ...
    public InMemBookingRepository() {
        ...
        Billing billing = new Billing("1", "Billing 1", "1", "1", "1", "1", LocalDate.now(), LocalTime.now());
        entities.put("1", billing);
        Billing billing2 = new Billing("2", "Billing 2", "2", "2", "2", "2", LocalDate.now(), LocalTime.now());
